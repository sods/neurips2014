...
of the links used for CMT exports are available [here](./Useful Links.ipynb).
...
[This notebook](./Import Meta Reviewer Suggestions.ipynb) does that.
...
import these to your local data base you use [this notebook](./Add Reviewers to
...
information from CMT use [this notebook](./Update DB from CMT Export.ipynb).
...
notebook](./Remind Missing TPMS.ipynb) downloads the output from Laurent's
...
authorship and reviewer are separate. [This notebook](./Find duplicate
...
notebook](./Duplicate Papers.ipynb) randomly selects 10% of the papers for
...
[This notebook](./Identify Shotgun Submissions.ipynb) tries to identify such
...
bidding stage. [This notebook](./Generate Bidding Lists.ipynb) contains code for
...
allocation with scripts based on similarity scores. [This notebook](./Paper
...
allocated reviewers that they have gained a paper. [This notebook](./Assignment
...
But did it work? In [this notebook](./Reviewer Expertise.ipynb) we explore the
...
notebook](./Import Review Scores.ipynb).
...
notebook](./Reviewer Calibration.ipynb) we try and correct for individual
...
[this notebook](./Attention%20Report.ipynb) an automated report is constructed
...
rejects. [This notebook](./Spreadsheet%20Reports.ipynb) creates and shares (via
...
notebook](./Update%20Spreadsheets.ipynb) (assuming the area chairs haven't
